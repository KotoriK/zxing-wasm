export default class WebGPUImageLumExtractor /* implements IImageLumExtractor */ {
    ...
    async extractVideoFrame(source, toArray) {
        ...
        computePass.dispatchWorkgroups(Math.ceil(this.#width / 16 * 4), this.#height);
        computePass.end();
        // 读取结果
        const readBuffer = this.#readBuffer;
        commandEncoder.copyBufferToBuffer(this.#outputBuffer, 0, readBuffer, 0, toArray.byteLength);
        // 提交命令
